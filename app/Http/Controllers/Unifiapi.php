...
class Unifiapi extends Controller
{
   public $user="admin";
   ...
   */
   public function init($mac, $ap_mac){
   		
   		$unifi = new unifiapi("admin","jmtz1","https://unifi.epoint.com.mx:8443", "default");
		$unifi->loginv4();
		$unifi->authorize_guest($mac, 420, $ap_mac);
   }
